    ...
    const handleTrack = async (e) => {
        ...
        try {
            ...
            if (searchType === "parcel") {
                url = `${baseUrl}/tracking/${searchValue}`;
            }
            ...
            /*
             * Parcel tracking endpoint may return an array.
             * Tracking ID endpoint may return a parcel object
            ...
            } else if (data?.tracking_history && Array.isArray(data.tracking_history)) {
                setTracking(data.tracking_history);
            } else {
                // If API returns single tracking object
                setTracking([data]);
            }
        } catch (error) {
            setError(
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-base-content/60 mt-2">
                        Search your parcel using Parcel ID or Tracking ID.
                    </p>
                    ...
                    tracking.length === 0 && (
                        ...
                        <div className="text-center py-10">
                            ...
                            <p className="text-base-content/60">
                                No tracking history found for this search.
                            </p>
